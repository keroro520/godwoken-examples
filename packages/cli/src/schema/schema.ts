...
export class DepositLockArgsCodec {
    ...
    HexSerialize(): HexString {
        const normalized = normalizers.normalizeObject("DepositLockArgs", this.depositLockArgs__, {
        ...
        return Reader.from( molecule.SerializeDepositLockArgs( normalized )  ).serializeJson();
    }
}
...
export class WithdrawalRequestExtraCodec {
    ...
    HexSerialize():HexString{
        const normalized=normalizers.normalizeObject("WithdrawalRequestExtra", this.withdrawalRequestExtra__,  {
            request: toNormalize((o1: Object)=>normalizers.normalizeObject("WithdrawRequest", o1, {
                    raw: toNormalize((o2: Object)=>normalizers.normalizeObject("RawWithdrawRequest", o2, {
        ...
        return Reader
            .from( molecule.SerializeWithdrawalRequestExtra( normalized )  )
            .serializeJson();
    }
}
...
export class WithdrawalRequestCodec {
    ...
    HexSerialize():HexString{
        const normalized=normalizers.normalizeObject("WithdrawalRequest", this.withdrawalRequest__, {
            raw: toNormalize((obj: Object)=>normalizers.normalizeObject("RawWithdrawRequest", obj, {
                nonce: normalizers.normalizeHexNumber(4),
                chain_id: normalizers.normalizeHexNumber(8),
                capacity: normalizers.normalizeHexNumber(8),
                amount: normalizers.normalizeHexNumber(16),
        ...
        return Reader
            .from( molecule.SerializeWithdrawalRequest( normalized )  )
            .serializeJson();
    }
}
...
export class RawWithdrawalRequestCodec {
    ...
    HexSerialize(): HexString {
        const normalized=normalizers.normalizeObject("RawWithdrawalRequest", this.rawWithdrawalRequest__, {
            nonce: normalizers.normalizeHexNumber(4),
            chain_id: normalizers.normalizeHexNumber(8),
            capacity: normalizers.normalizeHexNumber(8),
            amount: normalizers.normalizeHexNumber(16),
        ...
        return Reader.from( molecule.SerializeRawWithdrawalRequest( normalized )  ).serializeJson();
    }
}
